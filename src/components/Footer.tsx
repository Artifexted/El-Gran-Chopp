...
export default function Footer() {
	return (
		<footer className="py-2 flex flex-col mx-4 md:flex-row md:justify-between cursor-default">
			<p className="my-2 text-center max-lg:mx-auto lg:w-[40%] lg:text-left">
				Copyright © <span className="text-destacable">El Gran Chopp</span> {new Date().getFullYear()}. 
                Todos los derechos reservados.
			</p>
			<div className="flex space-x-2 max-lg:mx-auto lg:w-[20%] lg:justify-center items-end">
			...
			<p className="my-2 text-center max-lg:mx-auto lg:w-[40%] lg:text-right mt-auto">
				Sitio web hecho por 
				<span className="ml-1">
					<Link
